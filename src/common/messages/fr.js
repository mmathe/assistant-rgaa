...
const messages = {
	...
	'Test.apply.uncheck.alt': 'Interdit',
        ...
        'Test.comment.label': 'Commentaire sur l\'audit',
        'Test.comment.placeholder': 'Ajoutez ici votre analyse ou celle de l\'IA',
        'Test.comment.help': '500 caractères maximum pour décrire la décision prise.',
        'AiAnalysis.button.label': 'Analyse IA',
        'AiAnalysis.button.loading': 'Analyse IA…',
        'AiAnalysis.button.tooltip.disabled': 'Sélectionnez au moins une règle',
        'AiAnalysis.button.tooltip.configure': 'Configurez un fournisseur IA dans les options',
        'AiAnalysis.status.loading': 'Analyse IA en cours…',
        'AiAnalysis.status.success': 'Analyse IA terminée',
        'AiAnalysis.error.generic': 'Échec de l’analyse IA ({details})',
        'AiAnalysis.error.AI_ANALYSIS_EMPTY_SELECTION': 'Sélectionnez au moins une règle avant de lancer l’analyse IA.',
        'AiAnalysis.error.AI_ANALYSIS_MISSING_ENDPOINT': 'Aucun point de terminaison IA n’est configuré. Rendez-vous dans les options pour ajouter votre fournisseur.',
        'AiAnalysis.error.http': 'Erreur réseau (code {status}) lors de l’appel IA.',
        'AiAnalysis.error.dismiss': 'Fermer',
        'AiAnalysis.actions.export': 'Exporter JSON',
        'AiAnalysis.actions.copy': 'Copier',
        'AiAnalysis.copy.success': 'Résultats copiés dans le presse-papiers',
        'AiAnalysis.copy.error': 'Impossible de copier les résultats',
        'AiAnalysis.empty': 'Aucun résultat IA disponible pour le moment.',
        'AiAnalysis.table.rule': 'ID règle',
        'AiAnalysis.table.title': 'Intitulé',
        'AiAnalysis.table.result': 'Résultat',
        'AiAnalysis.table.comment': 'Commentaire',
        'AiAnalysis.table.lastRun': 'Dernière exécution',
        'AiAnalysis.table.model': 'Source IA',
        'AiAnalysis.table.context': 'Voir contexte',
        'AiAnalysis.result.C': 'Conforme',
        'AiAnalysis.result.NC': 'Non conforme',
        'AiAnalysis.result.NA': 'Non applicable',
        'AiAnalysis.drawer.title': 'Contexte envoyé à l’IA',
        'AiAnalysis.drawer.close': 'Fermer',
        'AiAnalysis.drawer.empty': 'Aucun contexte n’a été collecté pour cette règle.',
	...
	'ImportResult.nt.title': 'Résultat non testé d\'après le fichier importé',
        ...
        'Options.aiSettings.title': 'Configuration du fournisseur IA',
        'Options.aiSettings.provider.label': 'Fournisseur',
        'Options.aiSettings.endpoint.label': 'Point de terminaison API',
        'Options.aiSettings.endpoint.help': 'Adresse de base utilisée pour appeler le modèle (adapter selon votre fournisseur).',
        'Options.aiSettings.apiKey.label': 'Clé API',
        'Options.aiSettings.apiKey.help': 'La clé est stockée localement dans le navigateur.',
        'Options.aiSettings.model.label': 'Identifiant du modèle ou du déploiement',
        'Options.aiSettings.additionalHeaders.label': 'En-têtes HTTP supplémentaires (JSON)',
        'Options.aiSettings.additionalHeaders.help': 'Optionnel : utilisez un objet JSON pour ajouter des en-têtes personnalisés (par exemple {"api-key": "..."}).',
        'Options.aiSettings.additionalParameters.label': 'Paramètres supplémentaires de la requête (JSON)',
        'Options.aiSettings.additionalParameters.help': 'Optionnel : contenu JSON fusionné au corps de la requête pour adapter les appels au fournisseur choisi.',
        'Options.aiSettings.submit': 'Enregistrer',
        'Options.aiSettings.successMessage': 'Configuration IA enregistrée',
